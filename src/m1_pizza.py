...
def run_test_generate_points_on_circle():
    ...
    # Test 2:
    expected = [rg.Point(110.0, 60.0),  # All numbers are approximate.
                rg.Point(80.0, 90.0),
                rg.Point(50.0, 60.0),
                rg.Point(80.0, 30.0)]
    circle = rg.Circle(rg.Point(80, 60), 30)
...
def run_test_draw_points_on_circle():
    ...
    # Test 4:
    title = 'DRAW_POINTS_ON_CIRCLE, test 4:  8 orange dots.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(150, 220), 100)
...
def draw_points_on_circle(window, circle, number_of_points, color):
    ...
    for k in range(len(points)):
        circle_new = rg.Circle(points[k], 10)
...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 4:  14 slices on red circle, thin (thickness=4) orange lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(325, 230), 75)
    circle.fill_color = 'red'
    circle.outline_thickness = 4
    pizza(window, circle, 14, 'orange', 3)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    # Tests 3:
    title = 'POLYGON test 3:  8 segments with thick=3 blue lines;'
    window = rg.RoseWindow(550, 400, title)

    circle = rg.Circle(rg.Point(235, 220), 100)
    circle.outline_thickness = 3
    polygon(window, circle, 8, 'blue', 3)
    window.continue_on_mouse_click()
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:  16 red lines on blue circle, hops = 3.'
    window = rg.RoseWindow(480, 350, title)

    circle = rg.Circle(rg.Point(200, 100), 75)
    circle.fill_color = 'blue'
    fancy_polygon(window, circle, 16, 3, 'red', 5)
    window.close_on_mouse_click()
